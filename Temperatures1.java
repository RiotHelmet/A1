...
class Temperatures1
{
	public static void main (String[] args)
	{
		...
		for (int week = 1; week <= nofWeeks; week++) {
			minT[week] = t[week][1];
			for (int day = 1; day <= nofMeasurementsPerWeek; day++) {
				minT[week] = (minT[week] < t[week][day]) ? minT[week] : t[week][day];
				maxT[week] = (maxT[week] > t[week][day]) ? maxT[week] : t[week][day];
				sumT[week] += t[week][day];
			}
		...
		for (int week = 2; week <= nofWeeks; week++) {
			minTemp = (minTemp < minT[week]) ? minTemp : minT[week];
			maxTemp = (maxTemp > maxT[week]) ? maxTemp : maxT[week];
			sumTemp += sumT[week];
		}
